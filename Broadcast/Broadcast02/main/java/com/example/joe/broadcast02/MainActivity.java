...
public class MainActivity extends AppCompatActivity {
    ...
    private void processViews() {
        timetick_service_switch = findViewById(R.id.timetick_service_switch);
        boot_service_switch = findViewById(R.id.boot_service_switch);
        phonestate_service_switch = findViewById(R.id.phonestate_service_switch);
        wifistate_service_switch = findViewById(R.id.wifistate_service_switch);
