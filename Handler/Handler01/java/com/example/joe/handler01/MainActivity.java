package com.example.joe.handler01;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static class Handler01 extends Handler {
        ...
        private final WeakReference<MainActivity> hActivity;

        public Handler01(MainActivity activity) {
            hActivity = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            MainActivity activity = hActivity.get();
    ...
    private static class Handler02 extends Handler {
        ...
        public Handler02(MainActivity activity) {
            hActivity = new WeakReference<>(activity);
        }
    ...
    private static class Handler03 extends Handler {
        ...
        public Handler03(MainActivity activity) {
            hActivity = new WeakReference<>(activity);
        }
    ...
    private void processViews() {
        handler01_switch = findViewById(R.id.handler01_switch);
        handler02_switch = findViewById(R.id.handler02_switch);
        handler03_switch = findViewById(R.id.handler03_switch);

        handler01_seekbar = findViewById(R.id.handler01_seekbar);
        handler02_seekbar = findViewById(R.id.handler02_seekbar);
        handler03_seekbar = findViewById(R.id.handler03_seekbar);
    }
