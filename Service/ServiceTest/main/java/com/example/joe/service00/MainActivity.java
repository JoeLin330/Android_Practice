...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        startService(new Intent(MainActivity.this, MyService03.class));
        ...
        // 建立連結服務元件用的Intent物件
        Intent bindIntent = new Intent(MainActivity.this, MyService03.class);
    ...
    private void processViews() {
        service01_switch = findViewById(R.id.service01_switch);
        service02_switch = findViewById(R.id.service02_switch);
        configSwitch();
    }
        ...
        CompoundButton.OnCheckedChangeListener listener =
                new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton buttonView,
                        ...
                        //    啟動服務元件必須加入下列的敘述
                        intent.setPackage("com.example.joe.service00");
